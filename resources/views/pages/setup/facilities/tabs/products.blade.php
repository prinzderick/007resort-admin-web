...
<x-card title="Products sold here" subtitle="Price shown is what applies at this facility" flush>
    ...
    @if ($products->ok())
        <div class="table-scroll"><table class="data-table" data-testid="fac-products"><thead><tr><th>Product</th><th>Kind</th><th class="text-right">Price</th><th>Available</th></tr></thead><tbody>
