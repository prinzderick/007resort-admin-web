<x-layouts.app title="Suppliers">
    ...
    <x-card flush x-data="tableTools">
        ...
        @if ($suppliers->ok())
            <div class="table-scroll"><table class="data-table" data-testid="suppliers-table"><thead><tr><th data-sort>Supplier</th><th>Contact</th><th>Phone</th><th>Email</th><th>Active</th></tr></thead><tbody x-ref="body">
