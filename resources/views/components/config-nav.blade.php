<x-subnav :items="[
    ...
    ['Facilities', 'config.facilities', 'config.facilities', ['facility.configure', 'config.manage', 'booking.configure']],
    ['Catalog & prices', 'config.catalog', 'config.catalog', ['pricing.manage', 'config.manage', 'catalog.availability.manage', 'catalog.manage']],
    ...
    ['Booking rules', 'config.bookings', 'config.bookings', ['facility.configure', 'config.manage', 'booking.configure']],
