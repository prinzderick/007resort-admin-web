@props(['name', 'label' => null, 'hint' => null, 'value' => null, 'media' => null, 'required' => false, 'ratio' => '16/9', 'canPick' => true, 'error' => null])
...
@endphp
<div class="f-field" data-f="image" data-invalid="{{ $err ? 'true' : 'false' }}" x-data="cmsImage({ id: @js($val ?: ''), url: @js($url), alt: @js(is_array($media) ? ($media['alt'] ?? '') : '') })" data-testid="image-field-{{ $name }}">
