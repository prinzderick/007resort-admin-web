...
{
    private const MAP = [
        'success' => ['ACTIVE', 'ONLINE', 'LIVE', 'CAPTURED', 'PAID', 'COMPLETED', 'APPROVED', 'APPLIED', 'SYNCED', 'OK', 'POSTED', 'CLOSED', 'RESOLVED', 'CONFIRMED', 'AVAILABLE', 'SETTLED', 'ENABLED', 'REACTIVATED', 'SERVED', 'READY'],
        ...
        'danger' => ['FAILED', 'OFFLINE', 'REVOKED', 'REJECTED', 'CONFLICT', 'TERMINATED', 'REVERSED', 'EXPIRED', 'DOWN', 'CANCELLED', 'VOIDED', 'VOID', 'INACTIVE', 'DEACTIVATED'],
        'info' => ['OPEN', 'PARTIALLY_REFUNDED', 'REFUNDED', 'EXHAUSTED', 'ACCESS', 'RENTAL'],
    ];
